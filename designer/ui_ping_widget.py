...
class Ui_PingWidget(object):
    def setupUi(self, PingWidget):
        ...
        self.tipsLabel = QLabel(self.widget)
        self.tipsLabel.setObjectName(u"tipsLabel")
        font = QFont()
        font.setPointSize(10)
        self.tipsLabel.setFont(font)

        self.horizontalLayout.addWidget(self.tipsLabel)
...
"}")
        ...
        self.baseLayout.addWidget(self.widget)
